...
![登陆界面](https://wx-ma1.oss-cn-beijing.aliyuncs.com/age-stage/age-stage.png "登陆界面.png")

####  **功能设计图** 
![功能设计图](https://skywalking.pro/download/images/aged-stage/WechatIMG803.jpeg "功能设计图.png")
...
**系统功能持续更新中。。。**
#### 介绍
 **这是一个基于SpringBoot2.X VUE2.6 Antd1.7.2  MyBatisPlus Shiro1.5.0 Java1.8 实现的具备系统管理、权限管理、老人管理、护工、护工薪资、假勤、养老院资讯、活动、老人健康数据、设备保修、缴费信息等多个功能的养老院管理系统（也叫养老驿站系统）， 可作为商用、毕业设计项目、快速开发模版项目。** 
#### 项目所用技术
|技术点   | 描述  | 备注   |
| :------------: | :------------: | :------------: |
